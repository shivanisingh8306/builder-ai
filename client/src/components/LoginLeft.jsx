...
const LoginLeft = () => {
  return (
    <div className="hidden lg:flex lg:w-2/5 bg-[url('/bg.jpg')] bg-cover bg-center bg-no-repeat flex-col justify-between p-12 shrink-0 select-none">
      <div className="flex items-center gap-3">
        <img src="/logo.png" alt="Logo" className="size-9.5" />
        <span className="text-4xl font-medium text-white">WebCraft AI</span>
      </div>
      <div>
        ...
        <p className="text-zinc-300 text-sm mt-12">
          Copyright {new Date().getFullYear()} WebCraft AI
        </p>
      </div>
    </div>
  );
